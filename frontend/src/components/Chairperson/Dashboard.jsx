                            ...
                            return (
                              <div className="flex flex-col items-center gap-1">
                                <div className="flex items-center justify-center gap-1.5">
                                  ...
                                  <button
                                    onClick={() => reportAttempts > 0 ? navigate(`/reports/edit/${report.id || report._id}`) : showToast('No report edit attempts remaining.', 'warning')}
                                    ...
                                    <div className="flex items-center gap-1.5 justify-center">
                                      {linkedOD && (
                                        <>
                                          ...
                                          <button
                                            onClick={() => odAttempts > 0 ? navigate(`/ods/edit/${linkedOD.id || linkedOD._id}`) : showToast('No student OD resubmission attempts remaining.', 'warning')}
                                  ...
                                  <div className="md:col-span-1 bg-white dark:bg-vit-neutral-950 p-4 border border-vit-neutral-200 dark:border-vit-neutral-750 rounded-xl space-y-3">
                                    ...
                                    {status === 'partially_updated' && (
                                       <div className="space-y-1.5">
                                         <button
                                           onClick={() => odAttempts > 0 ? navigate(`/ods/edit/${linkedOD.id || linkedOD._id}`, { state: { resubmitMode: true } }) : null}
                                           disabled={odAttempts <= 0}
                    ...
                    <tr key={id} className="hover:bg-vit-neutral-100/30 dark:hover:bg-vit-neutral-800/30 transition-colors">
                      ...
                      <td className="px-6 py-4 text-center">
                        {op.hasOD ? (
                          ...
                          <button
                            onClick={() => navigate('/ods/new', { state: { selectedEventId: id, requestType: 'pre_event' } })}
